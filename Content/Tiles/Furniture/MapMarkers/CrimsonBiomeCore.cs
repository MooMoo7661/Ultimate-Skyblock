...
namespace UltimateSkyblock.Content.Tiles.Furniture.MapMarkers
{
    public class CrimsonBiomeCore : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<CrimsonBiomeCoreItem>(), 1);
            RegisterItemDrop(ModContent.ItemType<CrimsonBiomeCoreItem>());

            // Placement
            TileObjectData.newTile.CopyFrom(TileObjectData.Style3x3);
            TileObjectData.newTile.DrawYOffset = 6;
            TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(ModContent.GetInstance<CrimsonBiomeMapMarkerEntity>().Hook_AfterPlacement, -1, 0, true);
    ...
    public class CrimsonBiomeMapMarkerEntity : ModTileEntity
    {
        ...
        public override bool IsTileValidForEntity(int x, int y)
        {
            ...
            return tile != null && tile.HasTile && tile.TileType == ModContent.TileType<CrimsonBiomeCore>();
        }
