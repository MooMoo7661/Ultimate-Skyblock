...
{
    public class DeepstoneChestTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(200, 200, 200), Language.GetText("Mods.UltimateSkyblock.Tiles.ChestInfo.DeepstoneChest"), MapChestName);
            AddMapEntry(new Color(0, 141, 63), Language.GetText("Mods.UltimateSkyblock.Tiles.ChestInfo.DeepstoneChest"), MapChestName);

            RegisterItemDrop(ModContent.ItemType<DeepstoneChest>(), 1);
            RegisterItemDrop(ModContent.ItemType<DeepstoneChest>());
        ...
        {
            return Language.GetText("Mods.UltimateSkyblock.Tiles.ChestInfo.DeepstoneChest");
        }
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            else
            {
                if (isLocked)
                {
                    int key = ModContent.ItemType<DeepstoneChestKey>();
