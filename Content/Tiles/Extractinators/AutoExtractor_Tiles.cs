...
namespace OneBlock.Content.Tiles.Extractinators
{
    public class AutoExtractorTier1Tile : AutoExtractor_BaseTile
    {
        ...
        protected override string TilesheetPath => "OneBlock/Content/Tiles/Extractinators/AutoExtractorTier1Tile";
    ...
    {
        protected override int ExtractorTile => Type;
        protected override string TilesheetPath => "OneBlock/Content/Tiles/Extractinators/AutoExtractorTier2Tile";
    ...
    {
        protected override int ExtractorTile => Type;
        protected override string TilesheetPath => "OneBlock/Content/Tiles/Extractinators/AutoExtractorTier3Tile";
    ...
    {
        protected override int ExtractorTile => Type;
        protected override string TilesheetPath => "OneBlock/Content/Tiles/Extractinators/AutoExtractorTier4Tile";
    ...
    {
        protected override int ExtractorTile => Type;
        protected override string TilesheetPath => "OneBlock/Content/Tiles/Extractinators/AutoExtractorTier5Tile";
