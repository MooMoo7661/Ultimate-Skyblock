...
namespace UltimateSkyblock.Content.GlobalClasses
{
    public class GlobalSapling : GlobalTile
    {
        ...
        {
           if (type == TileID.Saplings || type == TileID.GemSaplings)
        ...
        {
            if ((type == TileID.Crystals || type == TileID.Titanstone || type == TileID.MythrilBrick || type == TileID.CobaltBrick) && !Main.hardMode)
            {
                noItem = true;
            }
        }
